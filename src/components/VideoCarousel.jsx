...
const VideoCarousel = () => {
  ...
  const [laodedData, setLoadedData] = useState([]);
  ...
  }, [startPlay, videoId, isPlaying, laodedData]);

  const hendleLoadedMedia = (i, e) => setLoadedData((prev) => [...prev, e]);
            ...
            <div className="video-carousel_container">
              <div className="w-full h-full flex-center rounded-3xl overflow-hidden bg-black">
                <video
                  ...
                  onLoadedMetadata={(e) => hendleLoadedMedia(i, e)}
                >
